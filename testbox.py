...
class GeneralizedRCNN(nn.Module):
    ...
    def training(self, bactched_inputs)
        ...
        """
    def inference(self, img_preprocess, detected_instances=None, do_postprocess=True):
...
# 1 get build backbone working first. 2. get basic stem working 3. get conv
# working .4 get empty tensor op working
# thank fucking god, I am finally done with the resnet part
