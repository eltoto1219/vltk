...
parser.add_argument('--model', default='res4', type=str, help='options: "res4", "res5"; features come from)')
...
if __name__ == "__main__":
    pathXid = load_image_ids(os.pardir + "/train_00")
    detector = build_model()
    extract_feat('open_image_d2obj36_batch.tsv', detector, pathXid)
