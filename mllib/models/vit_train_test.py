...
from vit_jax import checkpoint_test, flags, input_pipeline, models, train
...
class TrainTest(unittest.TestCase):
    def test_main(self):
        ...
        parser = flags.argparser(
            models.KNOWN_MODELS.keys(), input_pipeline.DATASET_PRESETS.keys()
        )
