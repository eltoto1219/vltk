...
class Optim:
    def __init__(self):
        if "OPTIMDICT" not in globals():
            global OPTIMDICT
            OPTIMDICT = import_funcs_from_file(OPTIMPATH, pkg="mllib.processing")
...
class Sched:
    def __init__(self):
        if "SCHEDDICT" not in globals():
            global SCHEDDICT
            SCHEDDICT = import_funcs_from_file(SCHEDPATH, pkg="mllib.processing")
    ...
    def __init__(self):
        if "LABELPROCDICT" not in globals():
            ...
            LABELPROCDICT = import_funcs_from_file(
                LABELPROCPATH, pkg="mllib.processing"
            )
    ...
    def __init__(self):
        if "IMAGEPROCDICT" not in globals():
            ...
            IMAGEPROCDICT = import_funcs_from_file(
                IMAGEPROCPATH, pkg="mllib.processing"
            )
